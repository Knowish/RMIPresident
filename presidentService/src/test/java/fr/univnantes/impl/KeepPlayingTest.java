...
public class KeepPlayingTest {
    ...
    @Test
    public void oneTimeoutScenarioReturnTrue() throws RemoteException, InterruptedException {
        PlayerInterface player1 = mock(PlayerInterface.class);
        PlayerInterface player2 = mock(PlayerInterface.class);
        PlayerInterface player3 = mock(PlayerInterface.class);
        PlayerInterface player4 = mock(PlayerInterface.class);
        ...
        when(player2.askKeepPlaying(2)).thenReturn(true);
        when(player3.askKeepPlaying(3)).thenReturn(true);
        when(player4.askKeepPlaying(4)).then(new TimeoutAnswerTrue());
    ...
    @Test
    public void oneTimeoutScenarioReturnFalse() throws RemoteException, InterruptedException {
        PlayerInterface player1 = mock(PlayerInterface.class);
        PlayerInterface player2 = mock(PlayerInterface.class);
        PlayerInterface player3 = mock(PlayerInterface.class);
        PlayerInterface player4 = mock(PlayerInterface.class);
        ...
        when(player2.askKeepPlaying(2)).thenReturn(true);
        when(player3.askKeepPlaying(3)).thenReturn(true);
        when(player4.askKeepPlaying(4)).then(new TimeoutAnswerFalse());
    ...
    private class TimeoutAnswerTrue implements Answer {
    ...
    private class TimeoutAnswerFalse implements Answer {
